...
missionNamespace setVariable ["SHOP_BUILDING", SHOP_BUILDING, true];
...
[] execvm "presets\var_setup_inc.sqf";
...
SHOP_ITEMS = [
//	Price	Display						Class
    [10,    "Earplugs",                 "ACE_EarPlugs"],
	[75,    "Morphine",                 "ACE_morphine"],
    [50,    "Bandage",                  "ACE_fieldDressing"],
    [300,   "Blood Bag (1L)",          "ACE_bloodIV"],
    [175,   "Blood Bag (500ml)",       "ACE_bloodIV_500"],
    [100,   "Blood Bag (250ml)",       "ACE_bloodIV_250"],
    [75,    "Epinephrine",              "ACE_epinephrine"],
    [25,    "Tourniquet",               "ACE_tourniquet"],
    [500,   "GPS",                      "ItemGPS"]
];
