		...
		if (getnumber (_weap >> "scope") == 2) then {
			if (isClass (_weap >> "ItemInfo")) then {
				...
				switch (_infoType) do {
					...
					case 101: {_muzzles = _muzzles + [configName _weap];};
...
List_AllOptics = _optics;
List_AllMuzzles = _muzzles;
List_AllRails = _railAttach;

publicVariableServer "List_Hats";
publicVariableServer "List_Uniforms";
publicVariableServer "List_Vests";
publicVariableServer "List_Backpacks";
publicVariableServer "List_Primaries";
publicVariableServer "List_Secondaries";
publicVariableServer "List_Launchers";
publicVariableServer "List_Optics";
publicVariableServer "List_Items";
publicVariableServer "List_Mines";
publicVariableServer "List_Glasses";
publicVariableServer "List_Faces";
publicVariableServer "List_AllWeapons";
publicVariableServer "List_AllClothes";
publicVariableServer "List_AllOptics";
publicVariableServer "List_AllMuzzles";
publicVariableServer "List_AllRails";
