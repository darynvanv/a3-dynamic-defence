...
if (!isDedicated) then {
    ...
    _dd_hostiles = missionNamespace getVariable ["dd_hostiles", 0];
    ...
    _attackWave = missionNamespace getVariable ["dd_round", 0];
    ...
    _hudText = format ["<t size='1' color='#ffffff'>%1</t>        <t size='1' color='#dddddd'>Wallet: R%2</t>        <t size='1' color='#dddddd'>Bank: R%4</t>        <t size='1' color='#dddddd'>Team Bank: R%5</t>        <t size='1' color='#cee5d0'>Wave: %3</t>        <t size='1' color='#d50000'>Hostiles: %6</t>",(name _player), _killPoints, _attackWave, _killPointsB, _killPointsGB, _dd_hostiles];
